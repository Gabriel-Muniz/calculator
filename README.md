# calculator
Final project from the first module on the odin project

# to-do list
I'm thinking of making the colors like a old gba style and also variables in css. So it's easier to make changes whenever i want so.
